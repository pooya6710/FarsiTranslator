...
def handle_menu_button(update: Update, context: CallbackContext) -> None:
    ...
    if callback_data == "back_to_start":
        # برگشت به منوی اصلی
        handle_back_to_start_sync(update, context)
    elif callback_data == "help":
        # نمایش راهنما
        handle_help_section_sync(update, context)
    elif callback_data == "about":
        # نمایش درباره ما
        handle_about_section_sync(update, context)
    elif callback_data == "help_video":
        # راهنمای کیفیت‌های ویدیو
        handle_video_help_sync(update, context)
    elif callback_data == "help_audio":
        # راهنمای دانلود صوتی
        handle_audio_help_sync(update, context)
    elif callback_data == "help_bulk":
        # راهنمای دانلود گروهی
        handle_bulk_help_sync(update, context)
    elif callback_data == "mydownloads":
        # نمایش دانلودهای کاربر
        handle_my_downloads_sync(update, context)
    else:
        logger.warning(f"دکمه نامشخص: {callback_data}")
        
# نسخه‌های sync از هندلرها
def handle_back_to_start_sync(update: Update, context: CallbackContext) -> None:
    """نسخه sync از handle_back_to_start"""
    query = update.callback_query
...
def handle_help_section_sync(update: Update, context: CallbackContext) -> None:
    """نسخه sync از handle_help_section"""
    query = update.callback_query
...
def handle_about_section_sync(update: Update, context: CallbackContext) -> None:
    """نسخه sync از handle_about_section"""
    query = update.callback_query
...
def handle_video_help_sync(update: Update, context: CallbackContext) -> None:
    """نسخه sync از handle_video_help"""
    query = update.callback_query
...
def handle_audio_help_sync(update: Update, context: CallbackContext) -> None:
    """نسخه sync از handle_audio_help"""
    query = update.callback_query
...
def handle_bulk_help_sync(update: Update, context: CallbackContext) -> None:
    """نسخه sync از handle_bulk_help"""
    query = update.callback_query
...
def handle_my_downloads_sync(update: Update, context: CallbackContext) -> None:
    """نسخه sync از handle_my_downloads"""
    query = update.callback_query
    user_id = update.effective_user.id

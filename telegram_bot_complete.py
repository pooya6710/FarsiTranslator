...
# -*- coding: utf-8 -*-
"""
فایل جامع ربات تلگرام دانلودر ویدیوهای اینستاگرام و یوتیوب

این فایل شامل تمام کدهای پروژه اصلی ربات تلگرام دانلودر می‌باشد که از فایل‌های زیر ترکیب شده است:
- telegram_downloader.py
- telegram_fixes.py
- audio_processing.py
- audio_processing/audio_extractor.py
- audio_processing/__init__.py
- debug_patch.py
- fix_telegram_issues.py
- instagram_fix_patch.py
- video_debugger.py
...
برای راه‌اندازی بدون اجرای تست‌ها، از آرگومان --skip-tests استفاده کنید:
   python telegram_bot_complete.py --skip-tests
"""
...
if __name__ == "__main__":
    # اجرای تابع اصلی ربات به جای تست عیب‌یابی
    # اگر این فایل به صورت مستقیم اجرا شود، ربات تلگرام را راه‌اندازی می‌کند
    try:
